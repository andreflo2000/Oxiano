...
const PILLARS_RO = [
  ...
  { icon: '📐', title: 'Validare out-of-sample riguroasă', body: 'Performanța nu este raportată pe datele de antrenament — ci exclusiv pe meciuri nevăzute de model (Oct 2025–Mar 2026). Pe picks cu confidence ≥65%, modelul a atins 62–67% acuratețe pe eșantionul de validare — față de 45–48% acuratețea unui pariator neinstruit pe același set de meciuri. Diferența este generată de filtrarea pe edge față de piața sharp.' },
...
const PILLARS_EN = [
  ...
  { icon: '📐', title: 'Rigorous out-of-sample validation', body: 'Performance is not reported on training data — only on matches unseen by the model (Oct 2025–Mar 2026). On picks with confidence ≥65%, the model achieved 62–67% accuracy on the validation set — vs. 45–48% for an uninformed bettor on the same matches. The difference is generated by filtering on edge against the sharp market.' },
...
const STATS_RO = [
  ...
  { value: '62–67%', label: 'acuratețe pe picks ≥65% conf.' },
...
const STATS_EN = [
  ...
  { value: '62–67%', label: 'accuracy on picks ≥65% conf.' },
